...
const LayoutRegisteredProfileIndexRoute = LayoutRegisteredProfileIndexImport.update({
    path: "/profile/",
    getParentRoute: () => LayoutRegisteredRoute,
} as any);

const LayoutRegisteredDashboardIndexRoute = LayoutRegisteredDashboardIndexImport.update({
    path: "/dashboard/",
    getParentRoute: () => LayoutRegisteredRoute,
} as any);
...
export const routeTree = rootRoute.addChildren([
    LayoutRoute.addChildren([
        LayoutRegisteredRoute.addChildren([LayoutRegisteredDashboardIndexRoute, LayoutRegisteredProfileIndexRoute]),
        LayoutIndexRoute,
    ]),
    AuthIndexRoute,
    AuthLoginIndexRoute,
